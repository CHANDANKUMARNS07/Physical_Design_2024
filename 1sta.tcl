...
read_liberty  ../module/timing_libs/$list_of_lib_files($i)
...
report_checks -path_delay min_max -fields {nets cap slew input_pins fanout} -digits {4} > /home/ms2024007/VSDBabySoC/output/min_max_$list_of_lib_files($i).txt
